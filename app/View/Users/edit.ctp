                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab_2">
                            <div class="row">
                                ...
                                <?php if ($this->Session->read('role')!='user') {
                                        ?>
                                    ...
                                    <label>Estatus:</label>
                                        ...
                                        echo $this->Form->input('estatus', array('label' => false,
                                            ...
                                            'options' => array('Activo' => 'Activo',
                                                'Bloqueado' => 'Bloqueado'),
                                            'selected' => $usuario['User']['estatus']))
                                        ?>   
                                </div>
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                    <label>Oficinas no asignadas:</label>
                                    
                                    <table class="table table-bordered">
                                        <tr>
                                          <th style="width: 10px">Seleccione</th>
                                          <th>Nombre</th>
                                          <th>Telefono</th>
                                      ...
                                      <input type="checkbox" name="ofiid[]" value="<?php echo $listado['Officce']['id']?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <?php foreach ($oficinassi as $listadosi): ?>
                                        <tr>
                                          <td>
                                            
                                                
                                      <input type="checkbox" name="ofiidsi[]" value="<?php echo $listadosi['OfficceUser']['id_office_user']?>">
                                                  
                                                
                                              &nbsp;</td>
                                          <td><?php echo h($listadosi['Officce']['nombre']); ?>&nbsp;</td>
                                          <td><?php echo h($listadosi['Officce']['telefono']); ?>&nbsp;</td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </table>
                                </div>
