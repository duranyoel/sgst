...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Modificacion de equipos/articulos/respuestos</h3>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
    ...
    <div class="box-body">
        <div class="form-group col-md-6">
            ...
            echo $this->Form->input('office_id', array('label' => false,
                ...
                'default'=>$datos['Article']['office_id'],
        ...
        <div class="form-group col-md-6">
            ...
            echo $this->Form->input('model_id', array('label' => false,
                ...
                'default'=>$datos['Article']['model_id'],));
        ...
        <div class="form-group col-md-12">
            ...
            echo $this->Form->input('descripcion', array('class' =>
                ...
                'value'=>$datos['Article']['descripcion'],
