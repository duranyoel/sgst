...
<div class="col-md-10">
    ...
    <?php echo $this->Form->create('Country', array('class' => 'form-inline')); ?>
...
<!--                    <td><?php // echo $this->Time->format('d/m/Y H:i:s',h($country['Country']['created'])); ?>&nbsp;</td>
                    <td><?php // echo $this->Time->format('d/m/Y H:i:s',h($country['Country']['modified'])); ?>&nbsp;</td>-->
                    <td><?php echo $this->Time->format('d/m/Y',h($country['Country']['created'])); ?>&nbsp;</td>
                    <td><?php echo $this->Time->format('d/m/Y',h($country['Country']['modified'])); ?>&nbsp;</td>
                    <td class="actions">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><?php echo $this->Html->link(__('Ver'), array('action' => 'view', $country['Country']['id'])); ?></li>
                                <li><?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $country['Country']['id'])); ?></li>
